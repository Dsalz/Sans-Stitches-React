...
const IndexNavbar = () => {
  return (
    <main className="index-landing">
      <section className="index-backdrop" />
      <section className="index-info">
        <div className="index-landing-img-div">
          <p>Tired of waiting for the government to work for you?</p>
        ...
        <h2>Take Back Your Country</h2>
        <p>A platform for you to speak up and have your voice be heard.</p>
        <p>Report wrong doings and general inadequacies in the country.</p>
        <Link to="/signup" className="index-landing-signup">
          Sign Up
        </Link>
